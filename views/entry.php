    ...
    function entryActions_selector($pkg){
        ...
        if($pkg['own_user']!=$_SESSION['UsrPkg']['username']){
            ...
            echo "<tr>
                ...
                <th style='width:45px'><button class='btn btn-light' id='btn_repost' onclick='letRep(this)' value='",$pkg['uid_post'],"'><img src='components/repost.png' style='width:28px;height:28px;'></img></button></th>
            </tr>";
        }else{
            //Entry owner is the same as logged user
            echo "<tr>
            <th id='entryTitle' colspan='2'>",$pkg['title'],"</th>
            <th style='width:45px'><button class='btn btn-info' id='btn_edit' onclick='letUpd(this)' value='",$pkg['uid_post'],"'><img src='components/edit.png' style='width:25px;height:25px;'></img></button></th>
            <th style='width:45px'><button class='btn btn-danger' id='btn_del' onclick='letRem(this)' value='",$pkg['uid_post'],"'><img src='components/delete.png' style='width:25px;height:25px;'></img></button></th>
            ...
            <th style='width:45px'><button class='btn btn-light' id='btn_repost' onclick='letRep(this)' value='",$pkg['uid_post'],"'><img src='components/repost.png' style='width:25px;height:25px;'></img></button></th>
            </tr>";
        }
    ...
    function entryAttached($pkg){
        if($pkg['attached_prop']!=0){
            ...
            if(!$pkg['attached_content']){
                ...
                echo "<tr><td colspan='6'><a href='viewPost.php?post=",$pkg['attached_uid_post'],"' target='_blank'>Ver original del post adjunto</a></td></tr>";
            }
            ...
            echo "<div id='",$pkg['uid_post'],"'>
                ...
                <td colspan='6'>
                    <span id='publishData'>Publicado por: <b>
                        ...
                        Fecha de publicación: <a href='viewPost.php?post=",$pkg['uid_post'],"' target='_blank'>",$pkg['pubdate'],"</a>
                    </span><br>
                </td>
                </tbody>
                </table>
