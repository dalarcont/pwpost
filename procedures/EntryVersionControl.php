<?php
    ...
    function getEntryVersions($idp,$lastversion){
        ...
        $Package = array();
        $SQL_Query = "SELECT * FROM entry_versioncontrol WHERE uuid_post = '$idp' AND edit_version NOT LIKE '$lastversion' ORDER BY pubdate DESC";
    ...
    function Post_VersionControl($user,$title,$content,$version,$objetive){
        ...
        $SQL_QUERY = "INSERT INTO entry_versioncontrol (commit_id, uuid_post, edit_version, own_user, pubdate, title, content)
